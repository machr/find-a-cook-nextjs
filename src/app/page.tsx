...
import { AddUpdateVenueForm } from "@/components/AddUpdateVenueForm";
import { UpdateAddSpecialsForm } from "@/components/UpdateAddSpecialsForm";
    ...
    <>
      ...
      <section>
        ...
        <div className="flex justify-between gap-6">
          <AddUpdateVenueForm venues={venues} />
          <UpdateAddSpecialsForm />
        </div>
      </section>
